...
ADMIN_MENU = [('View Users', 'View Users'), ('View Students', 'View Students'), ('Change User Information', 'Change User Information'), 
              ('View Courses', 'View Courses'), ('Change Courses', 'Change Courses'), ('View/Send Messages', 'View/Send Messages'),('Change Login Information','Change Login Information'), ('View Login Information','View Login Information')]
...
class ChangeLoginInfoForm(forms.Form):
    inputUser = forms.CharField(label='Username', required=True)
